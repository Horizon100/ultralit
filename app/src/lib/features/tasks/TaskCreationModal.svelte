<script lang="ts">
    ...
    function setEndOfWeekDeadline() {
      ...
      deadline.setDate(deadline.getDate() + (daysUntilEndOfWeek <= 0 ? daysUntilEndOfWeek + 7 : daysUntilEndOfWeek));
      task.due_date = deadline;
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="deadline-buttons">
            ...
            <button 
              class:selected={selectedDeadline === '3'}
              on:click={() => setQuickDeadline(3)}
            >
              3 Days
            </button>
            <button 
          ...
          {#if task.due_date}
            <div class="selected-date">
              ...
              <button class="clear-date" on:click={() => { task.due_date = null; selectedDeadline = null; }}>×</button>
            </div>
          {/if}
        </div>
