...
>
	...
	<div class="hero-container">
		<!-- Main hero circle -->
		<div class="hero-circle" class:current-user={isCurrentUser}>
			...
			{:else}
				<div class="hero-initials default">?</div>
			{/if}
		</div>
		...
		<div class="status-indicators">
			...
			{#if hero.currentRoom}
				<div class="location-tooltip" class:visible={isHovered}>📍 In room</div>
			{/if}
		</div>
	</div>
