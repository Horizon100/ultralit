<script lang="ts">
	...
	import { MessageSquare, Heart, Repeat, Share, MoreHorizontal, Paperclip } from 'lucide-svelte';
	...
	<div class="post-header">
			<a href="/{post.author_username}" class="avatar-link">
				<img
					...
					alt="{post.author_username || post.author_name || post.expand?.user?.username || 'Unknown'}'s avatar"
					class="post-avatar"
				/>
			</a>
		<div class="post-meta">
			...
			<a href="/{post.author_username || post.expand?.user?.username}" class="author-link">
				<div class="post-author">
					{post.author_name || post.author_username || post.expand?.user?.name || post.expand?.user?.username || 'Unknown User'}
				</div>
			</a>
