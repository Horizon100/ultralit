...
export class ContextAnalyzer {
  ...
  private static readonly PATTERNS = {
    code: {
      keywords: ['function', 'class', 'variable', 'array', 'object', 'method', 'algorithm', 'debug', 'fix', 'implement', 'code', 'typescript', 'javascript', 'python', 'api', 'database'],
      phrases: ['write a', 'create a', 'how to', 'implement', 'fix this', 'debug', 'optimize'],
      codeBlocks: /```|`[^`]+`|<code>/i
    },
    
    creative: {
      keywords: ['story', 'poem', 'creative', 'imagine', 'write', 'describe', 'narrative', 'character', 'plot', 'fiction'],
      phrases: ['write a story', 'create a poem', 'imagine if', 'tell me about', 'describe a scene']
    },
    
    factual: {
      keywords: ['what is', 'define', 'explain', 'how does', 'why', 'when', 'where', 'facts', 'information'],
