...
export const erpAgentTemplates = [
    {
        ...
        description: "Optimizes inventory levels, predicts demand, and ensures efficient stock management.",
    ...
    },
    {
        ...
        description: "Handles financial data analysis, budgeting, and forecasting for strategic financial planning.",
    ...
    },
    {
        ...
        description: "Automates HR functions, assists in recruitment, employee management, and performance tracking.",
    ...
    },
    {
        ...
        description: "Manages customer relationships, sales processes, and marketing campaigns within the ERP system.",
    ...
    },
    {
        ...
        description: "Optimizes the supply chain, ensuring efficient procurement, logistics, and supplier management.",
    ...
    },
    {
        ...
        description: "Ensures ERP system and business processes comply with regulations and manage risks.",
    ...
    },
    {
        ...
        description: "Optimizes production schedules and resource allocation within manufacturing processes.",
    ...
    },
    {
        ...
        description: "Streamlines procurement processes and manages vendor relationships within the ERP.",
    ...
    },
    {
        ...
        description: "Monitors and manages the IT infrastructure that supports the ERP system, ensuring stability and security.",
