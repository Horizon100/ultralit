...
export const availablePrompts: Array<{
...
}> = [
	{
		...
		icon: Share2,
		description:
			'Create detailed scenarios and use cases for your project. The AI will help you explore different possibilities and edge cases, generating comprehensive scenarios that cover various aspects of your requirements.',
	...
	},
	{
		...
		icon: CalendarRange,
		description:
			'Break down your projects into actionable tasks. The AI will help you create a structured task list with priorities, dependencies, and estimated effort levels to streamline your workflow.',
	...
	},
	{
		...
		icon: CodeXml,
		description:
			'Design and configure specialized AI agents for specific tasks. Define their behavior, capabilities, and interaction patterns to create autonomous agents that can handle specific aspects of your workflow.',
	...
	},
	{
		...
		icon: SearchSlash,
		description:
			'Analyze and optimize the relationships between different components in your system. Visualize connections, identify bottlenecks, and design efficient network architectures.',
	...
	},
	{
		...
		icon: BrickWall,
		description:
			'Improve and iterate on existing ideas or solutions. The AI will help you polish and enhance your current proposals, offering alternatives and optimizations.',
	...
	},
	{
		...
		icon: NotebookText,
		description:
			'Create concise summaries of complex information. Transform lengthy content into clear, digestible summaries while maintaining key points and insights.',
	...
	},
	{
		...
		icon: ChartScatter,
		description:
			'Create interconnected systems and relationships between different elements. Visualize and generate optimal network configurations based on your requirements.',
	...
	},
	{
		...
		icon: BookOpen,
		description:
			'Engage in natural, conversational interactions with the AI. Perfect for brainstorming, general discussions, and exploring ideas in a relaxed setting.',
