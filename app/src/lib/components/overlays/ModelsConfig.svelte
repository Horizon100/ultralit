        ...
        <div class="column form-column" transition:fly={{ x: 300, duration: 300 }}>
            <div class="form-content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="modelName" bind:value={modelName} placeholder="Enter model name...">
                </div>

                <div class="form-group">
                    <label for="modelDescription">Description</label>
                    <textarea id="modelDescription" bind:value={modelDescription} placeholder="Enter model description..."></textarea>
                </div>

                <div class="form-group">
                    <label for="modelApiKey">API Key</label>
                    <input type="password" id="modelApiKey" bind:value={modelApiKey} placeholder="Enter API key...">
                </div>

                <div class="form-group">
                    <label for="modelBaseUrl">Base URL</label>
                    <input type="text" id="modelBaseUrl" bind:value={modelBaseUrl} placeholder="Enter base URL...">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="modelApiVersion" bind:value={modelApiVersion} placeholder="Enter API version...">
                </div>
            </div>
