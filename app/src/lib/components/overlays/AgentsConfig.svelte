                    ...
                    <div class="filter-container">
                        <div class="filter-group">
                            <div class="filter-row">
                                ...
                                {#each roles as role}
                                    <button class="filter-button" class:active={selectedRole === role} on:click={() => selectedRole = role}>
                                        <svelte:component this={roleIcons[role]} size={24} />
                                        <span>{role}</span>
                                    </button>
                                {/each}
                                <button class="filter-button" class:active={!selectedRole} on:click={() => selectedRole = null}>
                                    Reset roles
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="filter-group">
                            <div class="filter-row">
                                ...
                                {#each statuses as status}
                                    <button class="filter-button status-{status}" class:active={selectedStatus === status} on:click={() => selectedStatus = status}>
...
<style>
    .agents-config {
        ...
        border-bottom: 5px solid #262929;
        border-left: 5px solid #262929;
        border-right: 5px solid #262929;
    ...
    .button-grid {
        display: grid;
        grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); /* Smaller min size for better responsiveness */
