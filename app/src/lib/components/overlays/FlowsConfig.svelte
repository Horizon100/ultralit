        ...
        <div class="column form-column" transition:fly={{ x: 300, duration: 300 }}>
            <div class="form-content">
                ...
                <div class="form-group">
                    ...
                    <textarea id="flowDescription" bind:value={flowDescription} placeholder="Enter flow description..."></textarea>
                </div>
                    ...
                    {#if Array.isArray(flowSummary)}
                        {#each flowSummary as item, index}
                            <div class="summary-item">
                                <input type="text" bind:value={flowSummary[index]} placeholder="Enter summary item...">
                                <button class="remove-button" on:click={() => removeSummaryItem(index)}>Remove</button>
                            </div>
                        {/each}
                    {/if}
