        ...
        <div class="column form-column" transition:fly={{ x: 300, duration: 300 }}>
            <div class="form-content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="actionName" bind:value={actionsName} placeholder="Enter action name...">
                </div>

                <div class="form-group">
                    <label for="actionDescription">Description</label>
                    <textarea id="actionDescription" bind:value={actionsDescription} placeholder="Enter action description..."></textarea>
                </div>

                <div class="form-group">
                    <label for="actionCode">Code</label>
                    <textarea id="actionCode" bind:value={actionsCode} placeholder="Enter action code..."></textarea>
                </div>
            </div>
