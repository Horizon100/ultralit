...
async function handleGetStarted() {
  ...
  <div class="swap-interface">
    <nav class="tab-menu">
      <button class="tab-item" class:active={activeTab === 'borrow'} on:click={() => activeTab = 'borrow'}>
        <Container />
        Borrow
      </button>
