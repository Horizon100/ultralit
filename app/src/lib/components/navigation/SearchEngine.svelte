      ...
      >
        <div class="result-content">
          ...
          <div class="result-meta">
            <span class="thread-name">{$t('generic.in')} {message.threadName || 'Unknown Thread'}</span>
            {#if message.userName}
      ...
      >
        <div class="result-content">
          ...
          <div class="result-meta">
            ...
            {#if task.due_date}
              <span class="separator">•</span>
              <span class="task-due-date">{$t('tasks.due')}  {new Date(task.due_date).toLocaleDateString()}</span>
            {/if}
            {#if task.priority}
              <span class="separator">•</span>
        ...
        <div class="result-content">
          ...
          <div class="result-meta">
            {#if post.author_name || post.author_username}
              <span class="user-name">{$t('generic.by')}  {post.author_name || post.author_username}</span>
            {/if}
            {#if post.created}
              <span class="separator">•</span>
            ...
            {#if post.commentCount > 0}
              <span class="separator">•</span>
              <span class="comment-count">{post.commentCount} {post.commentCount === 1 ? 'comment' : 'comments'}</span>
            {/if}
          </div>
        </div>
        <ArrowRight size={14} class="result-arrow" />
