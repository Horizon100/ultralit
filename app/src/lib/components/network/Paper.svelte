<script lang="ts">
    ...
    element.transition('size', { width: newSize, height: newSize }, {
        duration: duration,
    ...
    function getElementsBetween(start: joint.dia.Element, end: joint.dia.Element): joint.dia.Element[] {
    ...
    function getElements(element: joint.dia.Element, terminator: joint.dia.Element, opt: { outbound?: boolean; inbound?: boolean }): joint.dia.Element[] {
    ...
    function getSuccessors(element: joint.dia.Element, terminator: joint.dia.Element): joint.dia.Element[] {
        return getElements(element, terminator, { outbound: true });
    }

    function getPredecessors(element: joint.dia.Element, terminator: joint.dia.Element): joint.dia.Element[] {
