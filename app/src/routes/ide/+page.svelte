...
<div class="container">
	<div class="sidebar">
		<button
			...
			on:click={() => setActiveSection('explorer')}
		...
		<button
			...
			on:click={() => setActiveSection('search')}
			aria-label="Search"
		>
			<Search size={24} />
		</button>
		<button
			...
			on:click={() => setActiveSection('debug')}
			aria-label="Debug"
		>
			<Bug size={24} />
		</button>
	...
	<div class="main-content">
		...
		<div class="output-panel">
			<div class="tabs">
				<button
					class:active={activeSection !== 'debug'}
					on:click={() => setActiveSection('explorer')}>Output</button
				>
				<button class:active={activeSection === 'debug'} on:click={() => setActiveSection('debug')}
					>Debug</button
				>
			</div>
