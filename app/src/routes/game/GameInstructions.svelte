...
<!-- Instructions modal -->
{#if showInstructions}
  <div class="instructions-modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-100">
      ...
      <div class="instructions-content space-y-4 text-gray-700">
        <section>
          ...
          <ul class="list-disc list-inside space-y-1">
            <li>Welcome to the collaborative LLM workspace! This interface uses a Pokemon-inspired map layout.</li>
            <li>You start on the main map with different buildings representing different work areas.</li>
