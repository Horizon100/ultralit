<script lang="ts">
    ...
    $: filteredNotes = searchTerm
        ? Object.values($notesStore.notes).flat().filter(note => note.title.toLowerCase().includes(searchTerm.toLowerCase()))
        : [];
...
<div class="container" on:click={hideContextMenu}>
    ...
    <div class="explorer">
        <div class="explorer-header">
            ...
            <span class:active={activeSection === 'bookmarks'} on:click={() => activeSection = 'bookmarks'}>
            ...
            {#each rootFolders as folder (folder.id)}
                <div class="folder" 
                    ...
                    <div class="folder-title">
                        ...
                        <button class="context-menu-button" on:click|stopPropagation={(e) => showContextMenu(e, folder, true)}>
